...
function CustomModal (props){
  ...
  return (
      <Modal isOpen={true} toggle={props.toggle} className="modal-lg">
        <ModalHeader toggle={props.toggle}>/{activeItem.project}/{activeItemType}/</ModalHeader>
        <ModalBody>
          <Form>
          <FormGroup>
        ...
        <ModalFooter>
        <Button onClick={() => handleDelete(activeItem)}>Delete</Button> &nbsp;
        <Button color="primary" onClick={() => handleSave(activeItem,'update')}>Save</Button> &nbsp;
        </ModalFooter>
      </Modal>
    );
  }
